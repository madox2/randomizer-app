...
const sections = [
  { title: 'Numbers',      color: '#79C753', uri: '../resources/matches-full.svg' },
  { title: 'Coin',         color: '#F7786B', uri: '../resources/bottle.svg' },
  { title: 'Bottle',       color: '#B18F6A', uri: '../resources/numbers.svg' },
  { title: 'Magic 8-Ball', color: '#92B6D5', uri: '../resources/matches-full.svg' },
  { title: 'Matches',      color: '#FAE03C', uri: '../resources/dices.svg' },
  { title: 'Dices',        color: '#B565A7', uri: '../resources/custom.svg' },
]
